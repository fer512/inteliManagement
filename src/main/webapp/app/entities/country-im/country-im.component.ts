...
@Component({
    selector: 'jhi-country-im',
    templateUrl: './country-im.component.html'
})
export class CountryImComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.countryService
            ...
            .subscribe(
                (res: HttpResponse<ICountryIm[]>) => this.paginateCountries(res.body, res.headers),
    ...
    trackId(index: number, item: ICountryIm) {
        return item.id;
    }
    ...
    private paginateCountries(data: ICountryIm[], headers: HttpHeaders) {
