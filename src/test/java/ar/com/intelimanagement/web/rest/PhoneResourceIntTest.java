...
public class PhoneResourceIntTest {
    ...
    private static final PhoneType DEFAULT_TYPE = PhoneType.CELL_PHONE;
    private static final PhoneType UPDATED_TYPE = PhoneType.HOME_PHONE;

    private static final String DEFAULT_NUMPBER = "AAAAAAAAAA";
    private static final String UPDATED_NUMPBER = "BBBBBBBBBB";
    ...
    public void createPhone() throws Exception {
        ...
        assertThat(testPhone.getNumpber()).isEqualTo(DEFAULT_NUMPBER);
    }
    ...
    public void getAllPhones() throws Exception {
        ...
        restPhoneMockMvc.perform(get("/api/phones?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].numpber").value(hasItem(DEFAULT_NUMPBER.toString())));
    }
    ...
    public void getPhone() throws Exception {
        ...
        restPhoneMockMvc.perform(get("/api/phones/{id}", phone.getId()))
            ...
            .andExpect(jsonPath("$.numpber").value(DEFAULT_NUMPBER.toString()));
    }
    @Test
    @Transactional
    ...
    public void updatePhone() throws Exception {
        ...
        assertThat(testPhone.getNumpber()).isEqualTo(UPDATED_NUMPBER);
    }
