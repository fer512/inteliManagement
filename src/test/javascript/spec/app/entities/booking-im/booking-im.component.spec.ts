...
import { BookingImComponent } from 'app/entities/booking-im/booking-im.component';
...
describe('Component Tests', () => {
    describe('BookingIm Management Component', () => {
        let comp: BookingImComponent;
        let fixture: ComponentFixture<BookingImComponent>;
        let service: BookingImService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [InteliManagementTestModule],
                declarations: [BookingImComponent],
                providers: [
                    {
                ...
                .overrideTemplate(BookingImComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(BookingImComponent);
