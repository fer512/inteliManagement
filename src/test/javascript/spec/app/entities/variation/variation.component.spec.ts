...
import { VariationComponent } from 'app/entities/variation/variation.component';
...
describe('Component Tests', () => {
    describe('Variation Management Component', () => {
        let comp: VariationComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(VariationComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.variations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
