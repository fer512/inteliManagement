...
import { EmployeeImComponent } from 'app/entities/employee-im/employee-im.component';
...
describe('Component Tests', () => {
    describe('EmployeeIm Management Component', () => {
        let comp: EmployeeImComponent;
        let fixture: ComponentFixture<EmployeeImComponent>;
        let service: EmployeeImService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [InteliManagementTestModule],
                declarations: [EmployeeImComponent],
                providers: [
                    {
                ...
                .overrideTemplate(EmployeeImComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(EmployeeImComponent);
