...
import { NotificationImComponent } from 'app/entities/notification-im/notification-im.component';
...
describe('Component Tests', () => {
    describe('NotificationIm Management Component', () => {
        let comp: NotificationImComponent;
        let fixture: ComponentFixture<NotificationImComponent>;
        let service: NotificationImService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [InteliManagementTestModule],
                declarations: [NotificationImComponent],
                providers: [
                    {
                ...
                .overrideTemplate(NotificationImComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(NotificationImComponent);
