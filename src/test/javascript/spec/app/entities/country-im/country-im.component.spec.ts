...
import { CountryImComponent } from 'app/entities/country-im/country-im.component';
...
describe('Component Tests', () => {
    describe('CountryIm Management Component', () => {
        let comp: CountryImComponent;
        let fixture: ComponentFixture<CountryImComponent>;
        let service: CountryImService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [InteliManagementTestModule],
                declarations: [CountryImComponent],
                providers: [
                    {
                ...
                .overrideTemplate(CountryImComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(CountryImComponent);
