...
import { ProviderImComponent } from 'app/entities/provider-im/provider-im.component';
...
describe('Component Tests', () => {
    describe('ProviderIm Management Component', () => {
        let comp: ProviderImComponent;
        let fixture: ComponentFixture<ProviderImComponent>;
        let service: ProviderImService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [InteliManagementTestModule],
                declarations: [ProviderImComponent],
                providers: [
                    {
                ...
                .overrideTemplate(ProviderImComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(ProviderImComponent);
