...
import { CompanyImComponent } from 'app/entities/company-im/company-im.component';
...
describe('Component Tests', () => {
    describe('CompanyIm Management Component', () => {
        let comp: CompanyImComponent;
        let fixture: ComponentFixture<CompanyImComponent>;
        let service: CompanyImService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [InteliManagementTestModule],
                declarations: [CompanyImComponent],
                providers: [
                    {
                ...
                .overrideTemplate(CompanyImComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(CompanyImComponent);
